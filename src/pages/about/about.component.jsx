                    ...
                    <Row className="pt-3 pb-5 align-items-center">
                        ...
                        <Col xs={12} md={6}>
                            <Row className="align-items-start p-4 my-details rounded">
                                {/* Description */}
                                Hey there! I'm <strong>&nbsp;Victor Angelo Parangue.</strong> I am a 4th year Computer Engineering student currently studying at the University of British Columbia.
                                <br /><br />
                                I am currently a member of the UBC COOP program. Starting from January 2021, I will be working as a Junior Software Engineer at Tasktop Technologies Incorporated. 
                                Until then, I am working as a Junior SDK Support Engineer at SAMSUNG Research and Development Canada.
                                <br /><br />
